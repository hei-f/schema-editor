...
| 功能                       | 说明                                                                                                                                                                              |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🤝 **Agentic UI 开箱即用** | [Agentic UI](https://github.com/ant-design/agentic-ui) 已集成插件支持，开发环境下可直接调试 Bubble 组件数据                                                                       |
| 🎯 **智能元素检测**        | 按住 Alt/Option 键时自动检测和高亮目标元素                                                                                                                                        |
| 📝 **Schema 编辑器**       | 内置CodeMirror编辑器，支持JSON格式化、压缩、转义/去转义等操作                                                                                                                     |
| 💾 **实时更新**            | 修改后直接同步到页面                                                                                                                                                              |
| 👁️ **实时预览**            | 支持在编辑时实时预览Schema效果，可自定义预览组件                                                                                                                                  |
| 🔧 **JSON 智能修复**       | 自动检测JSON语法错误，一键定位错误位置并尝试智能修复，支持 Diff 对比查看修复前后差异                                                                                              |
| 🖱️ **快速单独编辑**        | 在编辑器中选中内容后可快速打开独立编辑弹窗，支持选中自动显示或右键触发两种模式，提供完整的编辑和格式化功能。支持组合键操作（加引号→去转义、压缩→转义→去引号），一键完成多步骤转换 |
| 🧠 **AST 自动补全**        | 编辑 AST 类型数据时提供字段名和类型的自动提示，支持快捷键触发                                                                                                                     |
...
| 🌈 **主题色配置**          | 支持自定义插件主题色，配置页面和编辑器界面统一应用 (v1.21.0+)                                                                                                                     |
...
编辑 AST (Elements[]) 类型数据时，插件提供字段名和类型的自动补全功能：
