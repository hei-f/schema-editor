 ...
 * 控制编辑器功能模块的启用/禁用
 */
export const FeatureToggleSection: React.FC<SectionProps> = (props) => {
  ...
  return (
    ...
    >
      <FormSection>
        <FormSectionLabelWithVariant id="field-feature-modules">
          功能模块
      ...
      <FormSection>
        <FormSectionLabelWithVariant id="field-toolbar-buttons">
          工具栏按钮
        </FormSectionLabelWithVariant>
        <FormContent>
          <FormRowContainer>
